...
Add Environment variable: Your project in Vercel > Settings > Environment Variables > add or upload .env file
...
closing the connection after connecting to mongodb 8. For JWT Token with HttpOnly Cookie
